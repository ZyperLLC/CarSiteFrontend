  ...
  const dealers = [
    {
      ...
      logo: "/dealerlogo.jpg?height=80&width=160",
      verified: true,
      rating: 4.8,
      totalReviews: 156,
      totalCars: 45,
      ...
      featuredCars: [
        { name: "Toyota Prius", price: "$95,000", image: "/car1.jpg?height=150&width=200" },
        { name: "Honda Vezel", price: "$120,000", image: "/car2.jpg?height=150&width=200" },
        { name: "Nissan Note", price: "$85,000", image: "/car3.jpg?height=150&width=200" },
      ],
    },
    {
      id: 2,
      ...
      featuredCars: [
        { name: "Toyota Aqua", price: "$75,000", image: "/car1.jpg?height=150&width=200" },
        { name: "Honda Fit", price: "$90,000", image: "/car2.jpg?height=150&width=200" },
        { name: "Suzuki Swift", price: "$80,000", image: "/car3.jpg?height=150&width=200" },
      ],
    },
    {
      id: 3,
      ...
      featuredCars: [
        { name: "BMW 3 Series", price: "$250,000", image: "/car1.jpg?height=150&width=200" },
        { name: "Audi A4", price: "$280,000", image: "/car2.jpg?height=150&width=200" },
        { name: "Mercedes C-Class", price: "$320,000", image: "/car3.jpg?height=150&width=200" },
      ],
    },
    {
      id: 4,
      ...
      featuredCars: [
        { name: "Hyundai Elantra", price: "$110,000", image: "/car1.jpg?height=150&width=200" },
        { name: "Kia Sportage", price: "$140,000", image: "/car2.jpg?height=150&width=200" },
        { name: "Mazda CX-5", price: "$160,000", image: "/car3.jpg?height=150&width=200" },
      ],
    },
  ]
