  ...
  const dealers = [
    {
      ...
      featuredCars: [
        { name: "Toyota Prius", price: "$95,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Honda Vezel", price: "$120,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Nissan Note", price: "$85,000", image: "/placeholder.svg?height=150&width=200" },
      ],
    },
    {
      id: 2,
      ...
      featuredCars: [
        { name: "Toyota Aqua", price: "$75,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Honda Fit", price: "$90,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Suzuki Swift", price: "$80,000", image: "/placeholder.svg?height=150&width=200" },
      ],
    },
    {
      id: 3,
      ...
      featuredCars: [
        { name: "BMW 3 Series", price: "$250,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Audi A4", price: "$280,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Mercedes C-Class", price: "$320,000", image: "/placeholder.svg?height=150&width=200" },
      ],
    },
    {
      id: 4,
      ...
      featuredCars: [
        { name: "Hyundai Elantra", price: "$110,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Kia Sportage", price: "$140,000", image: "/placeholder.svg?height=150&width=200" },
        { name: "Mazda CX-5", price: "$160,000", image: "/placeholder.svg?height=150&width=200" },
      ],
    },
  ]
  ...
  const filteredDealers = dealers
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case "cars": return b.totalCars - a.totalCars
            ...
            <div className="flex flex-wrap gap-4 w-full md:w-auto">
              <div className="relative w-full md:w-auto">
                <select
                  ...
                  className="p-2 border border-gray-300 rounded-lg appearance-none bg-white focus:ring-2 focus:ring-blue-500 pr-8 w-full md:w-auto"
                >
